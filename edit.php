...
<body class="bg-light">
  <div class="container mt-5">
    ...
    <form method="post" class="card p-4">
      <div class="mb-3">
        <label>Nama</label>
        <input type="text" name="nama" class="form-control" value="<?= htmlspecialchars($inventaris['nama']) ?>">
      </div>
      <div class="mb-3">
        <label>kategori</label>
        <input type="text" name="kategori" class="form-control" value="<?= htmlspecialchars($inventaris['kategori']) ?>">
      </div>
      <div class="mb-3">
        <label>Jumlah</label>
        <input type="text" name="jumlah" class="form-control" value="<?= htmlspecialchars($inventaris['jumlah']) ?>">
      </div>
      <div class="mb-3">
        <label>Lokasi</label>
        <textarea name="lokasi" class="form-control" rows="3"><?= htmlspecialchars($inventaris['lokasi']) ?></textarea>
      </div>
